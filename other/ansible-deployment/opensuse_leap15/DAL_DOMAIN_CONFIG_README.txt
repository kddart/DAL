...
2. Rename directory kddart.example.com in /srv/www/vhosts to kd.production-example.com

3. Rename DAL apache configuration file in /etc/apache2/vhosts.d from http-kddart.example.com.conf to http-kd.production-example.com.conf

4. Edit /etc/apache2/vhosts.d/http-kd.production-example.com.conf by:
...
5. Edit /srv/www/secure/kddart_dal.cfg by:
